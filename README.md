...
Приложение изначально разрабатывалось на **TypeScript**: все компоненты, страницы, Redux-хранилище и утилиты типизированы (`.tsx` / `.ts`).

### Реализованный функционал

- Сборка бургера с drag-and-drop
- Модальные окна ингредиента и заказа
- Redux Toolkit: ингредиенты, конструктор, заказ, модалка ингредиента, пользователь
...
- `main` — основная ветка
- `sprint4` — проектная работа 4-го спринта (типизация)
